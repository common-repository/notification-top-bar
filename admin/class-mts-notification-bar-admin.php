...
class MTSNB_Admin {
	...
	public function plugin_admin_menu() {
		...
		add_submenu_page(
			...
			__( '<style>.menu-icon-mts_notification_bar li:nth-of-type(4) {display: none !important;}</style>Settings', $this->plugin_name ),
			'manage_options',
			$this->plugin_name,
...
//		);
	...
	public function mts_notification_cpt() {
		$labels = array(
			'name'               => _x( 'Notification Bar', 'post type general name', $this->plugin_name ),
			'singular_name'      => _x( 'Notification Bar', 'post type singular name', $this->plugin_name ),
			'menu_name'          => _x( 'Notification Bar', 'admin menu', $this->plugin_name ),
			...
			'all_items'          => __( 'Notification Bars', $this->plugin_name ),
	...
	public function add_preview_button() {
		...
		if ( 'mts_notification_bar' === $post->post_type ) {
			echo '<div class="misc-pub-section">';
				echo '<a href="#" class="button" id="preview-bar"> '.__( 'Show Notification bar', $this->plugin_name ).'</a>';
			echo '</div>';
		}
	}
	...
	public function show_custom_meta_box( $post ) {
		...
		$general_options = array(
			array(
				'type' => 'select',
				'name' => 'button',
				'label' => __( 'Close Button', $this->plugin_name ),
				'default'=> 'no_button',
				'options' => array(
			...
			array(
				'type' => 'select',
				'name' => 'initial_state',
				'label' => __( 'Starter State', $this->plugin_name ),
				'options' => array(
			...
			array(
				'type' => 'number',
				'name' => 'content_width',
				'label' => __( 'Content Width', $this->plugin_name ),
				'default'=> '950'
			),
			array(
				'type' => 'select',
				'name' => 'css_position',
				'label' => __( 'Position Fixed or Absolute', $this->plugin_name ),
				'default'=> 'fixed',
				'options' => array(
			...
			array(
				...
				'label' => __( 'Show in top or bottom', $this->plugin_name ),
				'default'=> 'top',
				'options' => array(
		...
		$button_content_type_options = array(
			array(
				...
				'label' => __( 'Call to Action', $this->plugin_name ),
				'default'=> 'link',
				'options' => array(
			...
			array(
				'type' => 'text',
				'name' => 'basic_text',
				'label' => __( 'Text content', $this->plugin_name ),
				'default'=> ''
			),
			array(
				'type' => 'text',
				'name' => 'basic_link_text',
				'label' => __( 'Call to Action Text', $this->plugin_name ),
				'default'=> ''
			),
			array(
				'type' => 'text',
				'name' => 'basic_link_url',
				'label' => __( 'Call to Action Url', $this->plugin_name ),
				'default'=> ''
			),
		);
		...
		$newsletter_content_type_options = array(
			...
			array(
				...
				'label' => __( 'Provider', $this->plugin_name ),
				'default'=> 'fb',
				'options' => array(
		...
		$counter_content_type_options = array(
			...
			array(
				'type' => 'date',
				'name' => 'counter_date',
				'label' => __( 'Countdown End Date', $this->plugin_name ),
				'default'=> '',
			),
			array(
				'type' => 'time',
				'name' => 'counter_time',
				'label' => __( 'Countdown End Time', $this->plugin_name ),
				'default'=> '00:00',
			),
			array(
				'type' => 'text',
		...
		$popup_content_type_options = array(
			array(
				'type' => 'text',
				'name' => 'popup_text',
				'label' => __( 'Link Text', $this->plugin_name ),
				'default'=> ''
			),
			array(
				'type' => 'select',
				'name' => 'popup_video_type',
				'label' => __( 'Video Provider', $this->plugin_name ),
				'default'=> 'youtube',
				'options' => array(
		...
		$custom_content_type_options = array(
			array(
				'type' => 'textarea',
				'name' => 'custom_content',
				'label' => __( 'Custom content like shortcodes or text.', $this->plugin_name ),
				'default'=> ''
			),
		);
			...
			<div class="mtsnb-tabs-inner clearfix">
				...
				<ul class="mtsnb-tabs-nav" id="main-tabs-nav">
					<li>
						<a href="#tab-general" <?php if ( $active_tab === 'general' ) echo 'class="active"'; ?>>
							<span class="mtsnb-tab-title"><?php _e( 'Basic', $this->plugin_name ); ?></span>
						</a>
					</li>
					<li>
						<a href="#tab-type" <?php if ( $active_tab === 'type' ) echo 'class="active"'; ?>>
							<span class="mtsnb-tab-title"><?php _e( 'Content', $this->plugin_name ); ?></span>
						</a>
					</li>
					<li>
						<a href="#tab-style" <?php if ( $active_tab === 'style' ) echo 'class="active"'; ?>>
							<span class="mtsnb-tab-title"><?php _e( 'Design', $this->plugin_name ); ?></span>
						</a>
					</li>
					<li>
						<a href="#tab-conditions" <?php if ( $active_tab === 'conditions' ) echo 'class="active"'; ?>>
							<span class="mtsnb-tab-title"><?php _e( 'Hide & Show', $this->plugin_name ); ?></span>
						</a>
					</li>
				</ul>
				<div class="mtsnb-tabs-wrap" id="main-tabs-wrap">
					...
					<div id="tab-type" class="mtsnb-tabs-content <?php if ( $active_tab === 'type' ) echo 'active'; ?>">
						<div class="mtsnb-tab-options clearfix">
							...
							<ul class="mtsnb-tabs-nav" id="sub-tabs-nav">
								<li><a href="#tab-button" <?php if ( $content_type === 'button' ) echo 'class="active"'; ?>><?php _e( 'Call to Action', $this->plugin_name ); ?></a></li>
								<li><a href="#tab-newsletter" <?php if ( $content_type === 'newsletter' ) echo 'class="active"'; ?>><?php _e( 'Newsletter', $this->plugin_name ); ?></a></li>
								<li><a href="#tab-social" <?php if ( $content_type === 'social' ) echo 'class="active"'; ?>><?php _e( 'Social Media Icons', $this->plugin_name ); ?></a></li>
								<li><a href="#tab-countdown" <?php if ( $content_type === 'countdown' ) echo 'class="active"'; ?>><?php _e( 'Countdown', $this->plugin_name ); ?></a></li>
								<li><a href="#tab-popup" <?php if ( $content_type === 'popup' ) echo 'class="active"'; ?>><?php _e( 'Video Link', $this->plugin_name ); ?></a></li>
							...
							<div class="meta-tabs-wrap" id="sub-tabs-wrap">
								...
								<div id="tab-social" class="mtsnb-tabs-content <?php if ( $content_type === 'social' ) echo 'active'; ?>">
									...
									<button type="button" role="button" class="mtsnb-social-add-platform mtsnb-social-div button" id="mtsnb-social-add-platform">
										<?php _e('Add Social Media Icon', $this->plugin_name); ?>
									</button>
									<br/>
									<br/>
					...
					<div id="tab-style" class="mtsnb-tabs-content <?php if ( $active_tab === 'style' ) echo 'active'; ?>">
						<div class="mtsnb-tab-desc" style="text-align:center;">
							<h2 style="font-size: 20px; padding: 0; margin: 0; font-weight: bold;">Please upgrade to the <a target="_blank" href="http://plugin-boutique.com/notification-top-bar/">$5 version</a> to change design.</h2>
							<p style="margin-top:5px;"><a target="_blank" href="http://plugin-boutique.com/notification-top-bar/">Upgrading</a> allows you to change colors, padding, shadow, animation & much more.</p>
							<a href="http://plugin-boutique.com/notification-top-bar/" target="_blank" style="padding: 10px 15px; display: inline-block; background: #1ba79d; color: #fff; font-weight: bold; text-decoration: none; border-radius: 2px; margin: 7px 0px;">Upgrade now</a>
						</div>
					</div>
					<div id="tab-conditions" class="mtsnb-tabs-content <?php if ( $active_tab === 'conditions' ) echo 'active'; ?>">
						<div class="mtsnb-tab-desc"><?php _e( 'Choose when and where to hide and show the notification top bar.', $this->plugin_name ); ?></div>
						<div id="conditions-selector-wrap" class="clearfix">
							<div id="conditions-selector">
								<ul>
									...
									<li id="condition-location"  class="condition-checkbox <?php echo $condition_location_state.$condition_location_disabled; ?>">
										<?php _e( 'Show on specific pages', $this->plugin_name ); ?>
									...
									<li id="condition-notlocation" data-disable="location" class="condition-checkbox <?php echo $condition_notlocation_state.$condition_notlocation_disabled; ?>">
										<?php _e( 'Hide on Specific Pages', $this->plugin_name ); ?>
																			</li>
									...
									<li id="condition-less" class="condition-checkbox <?php echo $condition_less_state; ?>">
										<?php _e( 'Show X amount of times', $this->plugin_name ); ?>
																			</li>
									...
									<li id="condition-onmobile" data-disable="notonmobile" class="condition-checkbox <?php echo $condition_onmobile_state.$condition_onmobile_disabled; ?>">
										<?php _e( 'Only display on mobile devices', $this->plugin_name ); ?>
									...
									<li id="condition-notonmobile" data-disable="onmobile" class="condition-checkbox <?php echo $condition_notonmobile_state.$condition_notonmobile_disabled; ?>">
										<?php _e( 'Hide on mobile devices', $this->plugin_name ); ?>
							...
							<div id="conditions-panels">
								<div id="condition-location-panel" class="mtsnb-conditions-panel <?php echo $condition_location_state; ?>">
									<div class="mtsnb-conditions-panel-title"><?php _e( 'Show on specific pages', $this->plugin_name ); ?></div>
									<div class="mtsnb-conditions-panel-content">
										<div class="mtsnb-conditions-panel-desc"><?php _e( 'Upgrade to unlock this feature', $this->plugin_name ); ?></div>
										<p>
											Please upgrade to the <a href="http://plugin-boutique.com/notification-top-bar/" target="_blank" style="color:#0073aa">5$ version</a> to unlock this feature.<br>
											<a style="padding: 5px 10px; display: inline-block; background: #1ba79d; color: #fff; font-weight: bold; text-decoration: none; border-radius: 2px; margin: 7px 0px;" target="_blank" href="http://plugin-boutique.com/notification-top-bar/">Upgrade now</a>
										</p>
									</div>
								</div>
								<div id="condition-notlocation-panel" class="mtsnb-conditions-panel <?php echo $condition_notlocation_state; ?>">
									<div class="mtsnb-conditions-panel-title"><?php _e( 'Hide on Specific Pages', $this->plugin_name ); ?></div>
									<div class="mtsnb-conditions-panel-content">
										<div class="mtsnb-conditions-panel-desc"><?php _e( 'Upgrade to unlock this feature', $this->plugin_name ); ?></div>
										<p>
											Please upgrade to the <a href="http://plugin-boutique.com/notification-top-bar/" target="_blank" style="color:#0073aa">5$ version</a> to unlock this feature.<br>
								...
								<div id="condition-less-panel" class="mtsnb-conditions-panel <?php echo $condition_less_state; ?>">
									<div class="mtsnb-conditions-panel-title"><?php _e( 'Show X amount of times', $this->plugin_name ); ?></div>
									<div class="mtsnb-conditions-panel-content">
								...
								<div id="condition-onmobile-panel" class="mtsnb-conditions-panel <?php echo $condition_onmobile_state; ?>">
									<div class="mtsnb-conditions-panel-title"><?php _e( 'Only display on mobile devices', $this->plugin_name ); ?></div>
									<div class="mtsnb-conditions-panel-content">
										<div class="mtsnb-conditions-panel-desc"><?php _e( 'Upgrade to unlock this feature', $this->plugin_name ); ?></div>
										<p>
											Please upgrade to the <a href="http://plugin-boutique.com/notification-top-bar/" target="_blank" style="color:#0073aa">5$ version</a> to unlock this feature.<br>
								...
								<div id="condition-notonmobile-panel" class="mtsnb-conditions-panel <?php echo $condition_notonmobile_state; ?>">
									<div class="mtsnb-conditions-panel-title"><?php _e( 'Hide on mobile devices', $this->plugin_name ); ?></div>
									<div class="mtsnb-conditions-panel-content">
										<div class="mtsnb-conditions-panel-desc"><?php _e( 'Upgrade to unlock this feature', $this->plugin_name ); ?></div>
										<p>
											Please upgrade to the <a href="http://plugin-boutique.com/notification-top-bar/" target="_blank" style="color:#0073aa">5$ version</a> to unlock this feature.<br>
								...
								<div id="condition-referrer-panel" class="mtsnb-conditions-panel <?php echo $condition_referrer_state; ?>">
									...
									<div class="mtsnb-conditions-panel-content">
										...
										<div class="mtsnb-conditions-panel-opt <?php if ( '1' === $referrer_custom ) echo 'active'; ?>" data-checkbox="mtsnb_fields_conditions_referrer_custom">
											...
											<p><?php _e( 'Enter custom refferrers. Can be full URL or a pattern like ".example.com", type and hit enter to separate entries.', $this->plugin_name ); ?></p>
	...
	public function mtsnb_ad_columns_head( $columns ) {
		...
		$columns['impressions'] =  __( 'Views', $this->plugin_name );
		$columns['clicks']      =  __( 'Interactions', $this->plugin_name );
